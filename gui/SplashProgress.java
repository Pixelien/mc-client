...
import pixelclient.UnicodeFontRenderer;
...
public class SplashProgress {
	...
	public static void drawSplash(TextureManager tm) {
		...
		if(splash == null) {
			splash = new ResourceLocation("pixelclient/splash.png");
		}
		...
		Gui.drawScaledCustomSizeModalRect(0, 0, 0, 0, 1244, 700, scaledResolution.getScaledWidth(), scaledResolution.getScaledHeight(), 1244, 700);
		drawProgress();
	...
	private static void resetTextureState() {
		GlStateManager.textureState[GlStateManager.activeTextureUtil].textureName = -1;
